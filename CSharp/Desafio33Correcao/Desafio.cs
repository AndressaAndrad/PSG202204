...
namespace CapConsoleApp2.Desafios
{
    public class DesafioDojo : Desafio
    {
        ...
        private void Exercicio04()
        {
            ...
            List<Estado> estados = EstadoFakeDB.Estados.Where(est => est.Descricao.StartsWith(nome)).ToList();
        ...
        private void Exercicio05()
        {
            ...
            string nome = Console.ReadLine();
            List<Estado> estados = EstadoFakeDB.Estados.Where(est => est.SiglaUF.StartsWith(nome)).ToList();
            Impressoes.ImprimirEstados(estados);
        ...
        private void Exercicio06()
        {
            ...
            Console.Write("Informe a sigla de UF do Estado:");
            string nome = Console.ReadLine();
            List<Estado> estados = EstadoFakeDB.Estados.Where(est => est.RegiaoBrasil.StartsWith(nome)).ToList();
            Impressoes.ImprimirEstados(estados);
